...
#         assert imaging.getPicklePath(self.tiff_file, self.PROC_DAT_FOLDER) == pickle_path

# def test_getDate():
#     tiff_file = Path("Z:/2PImaging/Kerstin/HD7-wtb/20230119_HD7_wtb/tiffs/20230119_6s-ss96-wtb_brain2_r1.tif")
#     date = imaging.getDate(tiff_file)
#     assert date == datetime.datetime(2023, 1, 19, 15, 51, 41)
#     assert imaging.formatDate(date.year, date.month)  == "2023_01"
...
def test_getScanimageMetadata():
    ...
    metadata = imaging.getScanimageMetadata(scanimage_tiff_path)
...
def test_getImagejMetadata():
    ...
    metadata = imaging.getImagejMetadata(olympus_2p_tiff_path)
